...
**3. Intenção Positiva**
	...
	2. Alguns autores que já abordavam esse assunto e que eu tenho estudado:
		...
		2. [[Abraham Maslow]]: o criador da [[pirâmide de Maslow]] afirma que ==todas as ações humanas são motivadas por uma série de necessidades==, começando pelas mais básicas (como comida e abrigo) e subindo para aquelas necessidades consideradas mais complexas (como amor, autoestima e autorrealização).
			...
			3. [[Marshall Rosenberg]]: criador da [[Comunicação Não-Violenta (CNV)]], na década de 60. Basicamente, a essência da CNV é promover uma comunicação que preze pela compaixão e pela empatia. Rosenberg sempre foi um defensor muito grande de que ==todos os comportamentos são uma tentativa de atender a necessidades humanas universais==, e que a violência ou comportamentos prejudiciais são resultado da 1. não atendimento das necessidades e 2. de formas prejudiciais de atender a essas necessidades. 
				1. Ou seja, todas as ações seriam uma tentativa de atender uma necessidade humana, consequentemente, possuem uma intenção positiva. Nesse caso, esses comportamentos prejudicais, não são vistos como 'maus', na verdade, seriam ==estratégias mal orientadas ou ineficazes para atender a uma necessidade==.
				2. O que eu gostei muito da CNV quando estudei sobre ela, é que ela é um meio para que nós possamos compreender e, consequentemente, expressar as nossas necessidades de forma clara e eficaz. 
	3. Dentro da PNL, temos muitos autores que falam sobre o conceito de intenção positiva. Desde [[John Grinder]], até [[Richard Bandler]] e [[Tony Robbins]]. Tais pensadores afirmam que ==por trás de toda ação, não importa o quanto pareça ser negativa, existe uma intenção positiva==. Esse é, inclusive, um princípio fundamental da PNL.
		1. Todo e qualquer comportamento humano é motivado por um objetivo positivo, ou por uma necessidade emocional ([[necessidades emocionais]]) que o indivíduo espera alcançar. Então, por exemplo, uma pessoa pode tomar uma atitude aparentemente maldosa, com a intenção de, através daquele comportamento, se sentir pertencido a determinado grupo.
		2. A maior parte das pessoas não tem *consciência* de que, por trás de tudo que fazem, existe uma necessidade subjacente. As pessoas não sabem nem que possuem necessidades que precisam ser supridas! Consequentemente, tomam atitudes, sem mesmo saber o porquê aquilo é importante para elas, e acabam criando situações de desconforto para si e para muitas outras pessoas. Aquela pessoa, infelizmente, não aprendeu que é possível suprir a sua necessidade de uma forma mais saudável para o todo. A partir disso, ela utiliza de ==mecanismos de defesa para se proteger==. Invariavelmente, ao utilizar esses mecanismos, a pessoa machuca outros no caminho.
		3. Quando conseguimos entender a intenção positiva por trás de um comportamento, conseguimos ==abordar a raiz do problema, ao invés de simplesmente lidar com o sintoma==.
...
**PENSADORES:**
- [[Sigmund Freud]]
	- Freud poderia se perguntar quais experiências na infância de Hitler podem ter levado a esse comportamento, ou como seus sonhos e inconsciente poderiam revelar conflitos internos. Freud poderia teorizar que, em vez de ser puramente maligno ou "psicopata", Hitler era um indivíduo profundamente perturbado que estava tentando, de maneira distorcida e destrutiva, resolver conflitos psicológicos não resolvidos.
- [[Tony Robbins]]
