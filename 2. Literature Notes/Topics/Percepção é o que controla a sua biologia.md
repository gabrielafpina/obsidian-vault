...
**DEFINIÇÃO:** Como você vê o mundo é o que controla a sua biologia. Ou seja, a percepção é o que causa o comportamento.
	Cada um enxerga o mundo a partir da sua própria percepção.
...
Nós adaptamos os Genes de acordo com o ambiente em que acreditamos viver.

Nós acreditamos que vivemos, porque a percepção pode estar errada e, PERCEPÇÃO É CRENÇA. A percepção é uma interface entre o seu ambiente e a sua biologia. E tal como as [[crenças]], agem como um filtro, entre o real e a biologia.

O filtro das crenças vai interferir se não estiverem corretos. Se você têm crenças falsas, vai selecionar os genes que não estão adequados ao ambiente.

A vida contém tudo, mas *você só será capaz de ver o que os filtros da sua percepção permitirem*, e esses filtros são as experiências e crenças adquiridas durante nossa vida.
	O que mantém o equilíbrio disso tudo? A percepção correta, que vem da [[Consciência]].
	Quando você começa a perceber de uma forma diferente, a resposta muda e a fisiologia também muda.
...
- [[Estamos aqui, nessa existência, unicamente para fazer as nossas experiências]]