...
###### **DEFINIÇÃO:**
A lateralidade traz uma possibilidade suplementar para manter a vida em situações de catástrofe e assegurar a sobrevivência da espécie.
...
A lateralidade é a nossa auto expressão e ela não tem a ver com a mão que a gente escreve ou com o pé que a gente chuta, tem a ver com o [[Teste do A]]
...
Traz uma possibilidade suplementar para manter a vida em situações de catástrofe e assegurar a sobrevivência da espécie.

A lateralidade tem por efeito permitir o desenvolvimento de uma patologia com a qual ele tem mais chances de sobrevivência de acordo com a percepção do indivíduo.

>[!important] A lateralidade de base NUNCA muda, mesmo se em algum momento funcionemos no hemicórtex oposto.

Um dos nossos objetivos de vida é, cada vez mais, nos aproximarmos da nossa energia de base - porque ela faz parte da função biológica que viemos desempenhar. Dependendo do estímulo que tivemos, podemos funcionar de uma maneira diferente.
