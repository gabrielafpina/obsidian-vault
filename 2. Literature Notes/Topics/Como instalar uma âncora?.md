...
**DEFINIÇÃO:**
Pavlov descobriu que os cachorros, dependendo do que eles esperavam comer, produziam tipos diferentes de saliva, para ajudar na digestão de tipos diferentes de alimento. Graças a esses experimentos com esses animais, ele desenvolveu a teoria conhecida mundialmente como condicionamento clássico ou reflexo condicionativo.

A partir disso, entendemos que um hábito atrela-se, necessariamente, a alguma âncora, a algum condicionamento.

>[!important] Âncora = estado emocional + estímulo sensorial (qualquer um dos [[VACOG]])
...
Tem que ser a mesma intensidade, a mesma entonação, a mesma palavra-chave, o mesmo toque.
...
1. Escolha o estado emocional que você quer ter disponível;
	1. Sugestões: energia, tranquilidade, foco e concentração, abertura de coração.
2. Se encha desse estado emocional;
3. Faça um gesto que será o gesto único e exclusivo para esse estado emocional (precisa ser diferente do que você faz no dia a dia, também é importante que seja algo que você pode fazer na frente de outras pessoas).

OBS1: quando você for criar o seu estado, você pode estimular a sua ancoragem utilizando músicas que te façam sentir aquele estado mais presente em você.
