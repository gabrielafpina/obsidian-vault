...
[[Vicky Zhao]] fala bastante sobre o método e ela trouxe uma perspectiva bem interessante: a aplicação do método na sua vida, faz com que você se torne mais #consciente de si mesmo, uma vez que você começa a pensar diferente. VocÊ começa a pensar em Fleeting Notes, Literature Notes e Distilled/Permanent Notes. Você passa a observar melhor os seus pensamentos.
...
As regras são:
1. Quando estiver consumindo um conteúdo, é importante captar uma ideia atômicas ([[Anotação Atômica X]]) por nota. Algo breve, não mais do que 3 a 5 frases.
2. O conceito deve ser reescrito com as suas próprias palavras.
3. Anote as referências, para que você saiba de onde veio o conceito
