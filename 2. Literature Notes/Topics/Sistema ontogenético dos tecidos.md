...
Elas fazem parte de um sistema biológico inerente a todas as espécies.

Ela mostra que nem a localização dos Focos de Hamer ([[O que são Focos de Hamer?]]) no cérebro, a proliferação celular ("tumor") ou a perda de tecido que seguem um DHS ([[O que é um DHS?]]) são ACIDENTAIS. [[Nada é aleatório]].

Apesar do grande numero de órgão do nosso corpo, os tecidos que os compõem apresentam um modo muito preciso de responder às duas fases que se seguem a um DHS.

Na primeira fase (FA - [[Como funciona a fase ativa, da segunda Lei Biológica?]]), uns tecidos irão PROLIFERAR, outros NECROSAR e outros terão uma PERDA DE FUNÇÃO.

Na segunda fase (PCL - [[Como funciona a Fase Pós Conflitolítica (PCL), da segunda Lei Biológica?]]), respectivamente, esses tecidos que proliferaram vão NECROSAR, os que necrosaram vão PROLIFERAR e os que tiveram uma perda de função, vão ter uma RETOMADA DE FUNÇÃO.
