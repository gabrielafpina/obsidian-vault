...
É uma forma de trazer o Homem aos seus códigos de comportamento mais primitivos.

Cada chamada "enfermidade" tem que ser entendida como um PROGRAMA BIOLÓGICO ESPECIAL NA NATUREZA COM SENTIDO INTELIGENTE criado para resolver um choque biológico inesperado (DHS).

O programa biológico tem por sentido inteligente dar mais chance de sobrevivência, ou seja, "um ganho de tempo".
	Assim, é sempre importante buscarmos 'Qual é a vantagem de...?' ou 'Qual é o perigo de...?'
