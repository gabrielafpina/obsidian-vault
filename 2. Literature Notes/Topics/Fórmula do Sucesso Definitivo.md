...
**BIG IDEA:** Ter sucesso na vida não é um acidente. Existe um passoa 

**DEFINIÇÃO:** 'As pessoas que conseguiram superioridade seguem um caminho coerente para o sucesso. Chamo a isso de Fórmula do Sucesso Definitivo.'

**COMO:**
1. **META:** O primeiro passo para essa fórmula é saber seu **resultado**, isto é, definir precisamente o que se quer. 
