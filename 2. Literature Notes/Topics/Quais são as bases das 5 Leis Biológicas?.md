...
###### **DEFINIÇÃO:**
1. **Filogenia**: é o estudo relativo à evolução das especies.
	1. Nós carregamos a memória arcaica de como os animais se desenvolveram na natureza e quais estratégias de sobrevivência eles utilizaram.

2. **Ontogenia**: é o estudo das origens e do desenvolvimento de um embrião até atingir toda a sua forma plena, passando por todos os estágios evolutivos.
...
3. **Embriologia**: é o estudo do desenvolvimento do embrião e a formação de seus órgãos e sistemas a partir do ovo primitivo (zigoto).
	...
	2. É subdivida em 3 folhetos:
		...
		3. ***Ectoderme*:** é o nosso tecido de relação, a nossa vida em grupo, a vida de relacionamentos. A temática principal são os conflitos de contato e separação - um dos conflitos mais arcaicos que temos. 
			1. A relação com o grupo define quem eu sou dentro do grupo. Me sinto pertencente ou não?

A partir disso, não vemos mais um órgão impactado, vemos a origem embriológica de uma estrutura do órgão. O que importa não é o órgão, mas os tecidos que o formam. TODOS os órgãos tem mais de um tecido envolvido.
