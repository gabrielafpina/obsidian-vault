...
**DEFINIÇÃO:**
Esse é um passo do [[Parts Work]] um passo que envolve uma imersão profunda e completa em uma parte específica do eu, a fim de compreender plenamente essa parte de dentro.
...
6. **Expressão Autêntica**: Permitir que a parte se expresse autenticamente, seja através de palavras, emoções ou até mesmo movimentos físicos. Isso pode incluir expressar raiva, tristeza, alegria ou qualquer outra emoção que a parte esteja segurando.
    
7. **Observação de Mudanças**: À medida que você explora a parte, pode observar mudanças nela. Isso pode incluir uma sensação de alívio, uma mudança na forma como ela se vê ou uma nova compreensão de seu papel.
    
8. **Transição Cuidadosa**: Após explorar a parte, você faz uma transição cuidadosa para fora dela, voltando à perspectiva central. Isso permite que você observe a parte de fora e compare essa perspectiva com a experiência de estar dentro dela.
