...
###### **DEFINIÇÃO:**
O conceito de arquétipos vem da psicologia analítica de [[Carl Jung]] e se refere a símbolos universais que residem no [[Inconsciente Coletivo]]. Esses arquétipos podem ser usados de forma eficaz na comunicação para criar uma conexão mais profunda com o público. [[Quais são os tipos de comunicação existentes?]]

1. ***Propósito***: qual é a sua causa? Qual é o arquétipo da minha causa?
	1. Identificar o arquétipo que melhor representa a sua causa pode ajudar a comunicar seu propósito de forma mais impactante. Por exemplo, se você está focada em autoconhecimento e crescimento pessoal, o arquétipo do "Mago" ou "Sábio" pode ser mais apropriado.
...
3. ***Dominar as energias arquetípicas***: 4 grupos principais de arquétipos são divididos em 4 elementos - existe um 5 elemento. Você traz essas energias para o seu tom de voz, para a sua postura corporal, para a sua forma de falar.
	...
	2. **Ordem**: inocente, sabio, governante (terra - é a base)
		...
		4. **Como Usar**: Aqui, você é didático. Use a energia da terra para criar uma sensação de estabilidade e confiança.
	3. **Social:** homem comum, prestativo, amante (água - conexão)
		1. **Homem Comum**: Relatável e realista.
